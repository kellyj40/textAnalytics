...
# calculting the normal editdistances
normal_vals = []
...
# calculting the spam editdistances
spam_vals = []
for spam1 in spams:
    for spam2 in spams:
        if spam1 != spam2:
...
# calculting the mixed editdistances
mixed_vals = []
